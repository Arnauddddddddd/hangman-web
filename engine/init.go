...
func (g *Structure) init() {
	...
	g.listWordsAlien = []string{"MORT", "CREATURE", "VAISSEAU", "SURVIVANT", "MEURTRIER", "ORGANISME", "LANCE-FLAMME", "ANDROIDE", "ESPACE", "REINE-ALIEN", "OEUF", "PROIE", "HOTE", "TUER", "MONSTRE", "PLANETE", "AUTO-DESTRUCTION", "HYPER-SOMEIL", "SURVIE", "CONDUITS"}
	g.listWordsLotr = []string{"ELF", "ORQUE", "DRAGON", "MAGIE", "ARMURE", "GUERRIER", "SORCIER", "CREATURE", "ARGENT", "GROTTE", "ROYAUME", "DAGUE", "NAIN", "MAGIE", "PERIPLE", "BATAILLE", "ARC", "ANNEAU", "HOBBIT", "BATAILLE", "TOUR", "PRECIEUX"}
	g.listWordsFc = []string{"SAVON", "COMBAT", "CIGARETTE", "VIOLENCE", "NARRATEUR", "ANARCHIE", "BOMBE", "INSOMNIE", "DESTRUCTION", "REGLES", "PROJET-CHAOS", "HALLUCINATION", "REVOLUTION", "PSYCHANALYSE", "SABOTAGE", "DESILUSION", "AMNESIE", "SCHIZOPHRENIE", "REGLES", "REGLES" }

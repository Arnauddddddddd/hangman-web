...
func (g *Structure) init() {
	...
	g.listWordsJurassic = []string{"SAVON", "COMBAT", "CIGARETTE", "VIOLENCE", "NARRATEUR", "ANARCHIE", "BOMBE", "INSOMNIE", "DESTRUCTION", "REGLES", "CHAOS", "HALLUCINATION", "REVOLUTION", "PSYCHANALYSE", "REGLES", "REGLES", "REGLES", "REGLES", "REGLES", "REGLES" }
